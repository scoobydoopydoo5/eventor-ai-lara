              ...
              <div className="flex items-center gap-4">
                <Avatar className="h-24 w-24">
                  ...
                  <AvatarFallback className="text-2xl">
                    <Cat size={64} mood="excited" color={kawaiiColor} />
                  </AvatarFallback>
                </Avatar>{" "}
                <div>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Username is set by your account. Your public profile: /p/
                {user?.username ||
                  user?.firstName ||
                  user?.emailAddresses[0]?.emailAddress?.split("@")[0] ||
                  "username"}
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Allow others to view your profile at /p/
                  {user?.username ||
                    user?.firstName ||
                    user?.emailAddresses[0]?.emailAddress?.split("@")[0] ||
                    "username"}
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  Display your name on public profile
                </p>
              </div>
              <Switch
                id="showName"
                ...
                onCheckedChange={(checked) =>
                  setFormData((prev) => ({ ...prev, showName: checked }))
                }
                disabled={loadingProfile}
              />
            </div>
