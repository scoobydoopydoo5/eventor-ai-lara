...
Budget: ${eventData.estimated_budget || 'TBD'} ${eventData.currency || 'USD'}
  ...
  "faqs": [
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "You are an event planning expert. Generate realistic, helpful FAQ items. Always respond with valid JSON only." },
